...
# Total:        114  160  28.0    172     199#
 ...
 ab -n 10 -v 4 -p data.json -T 'application/json' -H 'Authorization: Bearer aKmadgH8NiuWvc8cm01EpdYtPsKGETfA' http://8e27e091-e612-4ffa-a09c-c9f7ec24ea55.southcentralus.azurecontainer.io/score
